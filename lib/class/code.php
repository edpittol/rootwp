...
class Code
{
     ...
     *
     */
    public static function controller( $attr, $content, $tag )
    {
    ...
    public static function add( $tag, $callback, $attr=null )
    {
        ...
        // var_dump( $tag );
        add_shortcode( $tag, 'code_controller' );
    }
...
// add_shortcode accepts only function on callback, not method

function code_controller( $attr, $content, $tag )
{
    return Code::controller( $attr, $content, $tag );
}
